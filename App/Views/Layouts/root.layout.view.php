        ...
        <div class="collapse navbar-collapse" id="navbarUserMenu">
            <?php if ($user->isLoggedIn()) { ?>
                <ul class="navbar-nav d-sm-none w-100">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= $link->url('attempt.results') ?>">Show attempts</a></li>
                ...
                <ul class="navbar-nav ms-auto d-none d-sm-flex">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenuDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?= $link->url('attempt.results') ?>">Show Attempts</a></li>
